...
<body>
    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            <h1>DATA PASIEN PKS</h1>
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="../pages/home.php">Home</a></li>
                    <li class="breadcrumb-item active">Data Pasien PKS</li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="1">
                                    ...
                                    <tbody>
                                        <?php
                                        require "../api/koneksi.php";
                                        $sql = mysqli_query($koneksi, "SELECT * from tbl_pasien WHERE estate='PKS' order by id Desc") or die("error karena" . mysqli_error($connection));
                                        $no = 1;
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td style="text-align: center; width: 30%;">
                                                    <a href="../forms/edit_pom.php?id=<?= $read['id_pasien'] ?>" class="label label-sm label-info">
                                                        <i class="bi bi-pencil-square btn btn-success btn-sm"></i></a>
                                                    <a href="../api/delete_pom.php?id=<?= $read['id_pasien'] ?>" onclick="return confirm('Apakah Anda Yakin Ingin Menghapusnya ?')">
