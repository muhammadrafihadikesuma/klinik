    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Level III</li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
        ...
        <section class="section">
            <div class="card shadow mb-4">
                <div class="col-lg-12">
                    <div class="card-body">
                        <h5 class="card-title">Level III</h5>
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered" id="dataTable" width="100%" cellspacing="1">
                                    ...
                                    <tbody>
                                        ...
                                        $start = date('Y-m-d',strtotime('-2 days',$nows));
                                        $end = date('Y-m-d',strtotime('-100 days'));
                                        $no = 1;
                                        $sql = mysqli_query($koneksi, "SELECT * from tbl_pendaftaran WHERE tanggal_pendaftaran BETWEEN (current_date()- interval 100 day) AND (current_date() - interval 9 day) ORDER BY tanggal_pendaftaran DESC") or die("error karena" . mysqli_error($koneksi));
