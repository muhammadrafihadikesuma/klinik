...
<body>
    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            <h1>EDIT PASIEN REGIONAL OFFICE</h1>
            <nav>
                <ol class="breadcrumb">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="../api/edit_ro.php" method="POST">
                                ...
                                <div class="form-floating mb-3">
                                    <select class="form-select" aria-label="Default select example" id="floatingStatus" name="status_pasien" required>
                                        ...
                                        <option <?php if ($status_pasien == 'Keluarga Tambahan') {
                                                    # code...
                                                    echo 'selected';
                                                } ?> value="Keluarga Tambahan">Keluarga Tambahan</option>
                                ...
                                <div class="col-12">
                                    <div class="form-floating mb-3">
                                        <select class="form-select" id="floatingJabatan" name="jabatan_pekerja" style="width: 100%;" data-placeholder="Pilih Jabatan">
                                            ...
                                            <option <?php if ($jabatan_pekerja == 'Perawatan') {
                                                        # code...
                                                        echo 'selected';
                                                    } ?> value="Perawatan">Perawatan</option>
                                ...
                                <div class="col-12">
                                    <div class="form-floating mb-3">
                                        <select class="form-select" aria-label="Default select example" id="floatingEstate" name="estate" required>
                                            ...
                                            <option <?php if ($estate == 'Regional Office') {
                                                        # code...
                                                        echo 'selected';
                                                    } ?> value="Regional Office">Regional Office</option>
                                ...
                                <div class="col-12">
                                    <div class="form-floating mb-3">
                                        <select class="form-select" aria-label="Default select example" id="floatingOp" name="op" required>
                                            ...
                                            <option <?php if ($op == 'Regional Office') {
                                                        # code...
                                                        echo 'selected';
                                                    } ?> value="Regional Office">Regional Office</option>
                                            ...
                                            <option <?php if ($op == 'OP 97 A') {
                                                        # code...
                                                        echo 'selected';
                                                    } ?> value="OP 97 A">OP 97 A</option>

                                            <option <?php if ($op == 'OP 97 B') {
                                                        # code...
                                                        echo 'selected';
                                                    } ?> value="OP 97 B">OP 97 B</option>

                                            <option <?php if ($op == 'OP 97 C') {
                                                        # code...
                                                        echo 'selected';
                                                    } ?> value="OP 97 C">OP 97 C</option>

                                            <option <?php if ($op == 'OP 97 D') {
                                                        # code...
                                                        echo 'selected';
                                                    } ?> value="OP 97 D">OP 97 D</option>

                                            <option <?php if ($op == 'OP 98 A') {
                                                        # code...
                                                        echo 'selected';
                                                    } ?> value="OP 98 A">OP 98 A</option>

                                            <option <?php if ($op == 'OP 98 B') {
                                                        # code...
                                                        echo 'selected';
                                                    } ?> value="OP 98 B">OP 98 B</option>

                                            <option <?php if ($op == 'OP 98 C') {
                                                        # code...
                                                        echo 'selected';
                                                    } ?> value="OP 98 C">OP 98 C</option>

                                            <option <?php if ($op == 'OP 98 D') {
                                                        # code...
                                                        echo 'selected';
                                                    } ?> value="OP 98 D">OP 98 D</option>
                                            ...
                                            <option <?php if ($op == 'OP 2005 A') {
                                                        # code...
                                                        echo 'selected';
                                                    } ?> value="OP 2005 A">OP 2005 A</option>

                                            <option <?php if ($op == 'OP 2005 B') {
                                                        # code...
                                                        echo 'selected';
                                                    } ?> value="OP 2005 B">OP 2005 B</option>

                                            <option <?php if ($op == 'OP 2006 A') {
                                                        # code...
                                                        echo 'selected';
                                                    } ?> value="OP 2006 A">OP 2006 A</option>

                                            <option <?php if ($op == 'OP 2006 B') {
                                                        # code...
                                                        echo 'selected';
                                                    } ?> value="OP 2006 B">OP 2006 B</option>

                                            <option <?php if ($op == 'OP 2007 A') {
                                                        # code...
                                                        echo 'selected';
                                                    } ?> value="OP 2007 A">OP 2007 A</option>

                                            <option <?php if ($op == 'OP 2007 B') {
                                                        # code...
                                                        echo 'selected';
                                                    } ?> value="OP 2007 B">OP 2007 B</option>
